...
var $ = require("jquery")(jsdom.jsdom().parentWindow);
      ...
      function fnUpdateProgress() {
        ...
        agTimelineItem.each(function () {
          ...
          (agTop + agPosY - $(window).scrollTop()) < agPosY + .5 * agOuterHeight ? $(this).addclassName('js-ag-active') : $(this).removeclassName('js-ag-active');
        })
      }
        ...
        <div className="ag-timeline_list">
            ...
            <div className="ag-timeline-card_item">
              <div className="ag-timeline-card_inner">
                <div className="ag-timeline-card_img-box">
                  <img src="https://raw.githubusercontent.com/SochavaAG/example-mycode/master/pens/timeline/images/img-13.png" className="ag-timeline-card_img" width="640" height="360" />
                </div>
          ...
          <div className="js-timeline_item ag-timeline_item">
            ...
            <div className="ag-timeline-card_item">
              <div className="ag-timeline-card_inner">
                <div className="ag-timeline-card_img-box">
                  <img src="https://raw.githubusercontent.com/SochavaAG/example-mycode/master/pens/timeline/images/img-12.png" className="ag-timeline-card_img" width="640" height="360" alt="" />
                </div>
                <div className="ag-timeline-card_info">
          ...
          <div className="js-timeline_item ag-timeline_item">
            ...
            <div className="ag-timeline-card_item">
              <div className="ag-timeline-card_inner">
                <div className="ag-timeline-card_img-box">
                  <img src="https://raw.githubusercontent.com/SochavaAG/example-mycode/master/pens/timeline/images/img-11.png" className="ag-timeline-card_img" width="640" height="360" alt="" />
                </div>
                <div className="ag-timeline-card_info">
          ...
          <div className="js-timeline_item ag-timeline_item">
            ...
            <div className="ag-timeline-card_item">
              <div className="ag-timeline-card_inner">
                <div className="ag-timeline-card_img-box">
                  <img src="https://raw.githubusercontent.com/SochavaAG/example-mycode/master/pens/timeline/images/img-10.png" className="ag-timeline-card_img" width="640" height="360" alt="" />
                </div>
                <div className="ag-timeline-card_info">
          ...
          <div className="js-timeline_item ag-timeline_item">
            ...
            <div className="ag-timeline-card_item">
              <div className="ag-timeline-card_inner">
                <div className="ag-timeline-card_img-box">
                  <img src="https://raw.githubusercontent.com/SochavaAG/example-mycode/master/pens/timeline/images/img-9.png" className="ag-timeline-card_img" width="640" height="360" alt="" />
                </div>
                <div className="ag-timeline-card_info">
          ...
          <div className="js-timeline_item ag-timeline_item">
            ...
            <div className="ag-timeline-card_item">
              <div className="ag-timeline-card_inner">
                <div className="ag-timeline-card_img-box">
                  <img src="https://raw.githubusercontent.com/SochavaAG/example-mycode/master/pens/timeline/images/img-8.png" className="ag-timeline-card_img" width="640" height="360" alt="" />
                </div>
                <div className="ag-timeline-card_info">
          ...
          <div className="js-timeline_item ag-timeline_item">
            ...
            <div className="ag-timeline-card_item">
              <div className="ag-timeline-card_inner">
                <div className="ag-timeline-card_img-box">
                  <img src="https://raw.githubusercontent.com/SochavaAG/example-mycode/master/pens/timeline/images/img-7.png" className="ag-timeline-card_img" width="640" height="360" alt="" />
                </div>
                <div className="ag-timeline-card_info">
          ...
          <div className="js-timeline_item ag-timeline_item">
            ...
            <div className="ag-timeline-card_item">
              <div className="ag-timeline-card_inner">
                <div className="ag-timeline-card_img-box">
                  <img src="https://raw.githubusercontent.com/SochavaAG/example-mycode/master/pens/timeline/images/img-6.png" className="ag-timeline-card_img" width="640" height="360" alt="" />
                </div>
                <div className="ag-timeline-card_info">
          ...
          <div className="js-timeline_item ag-timeline_item">
            ...
            <div className="ag-timeline-card_item">
              <div className="ag-timeline-card_inner">
                <div className="ag-timeline-card_img-box">
                  <img src="https://raw.githubusercontent.com/SochavaAG/example-mycode/master/pens/timeline/images/img-5.png" className="ag-timeline-card_img" width="640" height="360" alt="" />
                </div>
                <div className="ag-timeline-card_info">
          ...
          <div className="js-timeline_item ag-timeline_item">
            ...
            <div className="ag-timeline-card_item">
              <div className="ag-timeline-card_inner">
                <div className="ag-timeline-card_img-box">
                  <img src="https://raw.githubusercontent.com/SochavaAG/example-mycode/master/pens/timeline/images/img-4.png" className="ag-timeline-card_img" width="640" height="360" alt="" />
                </div>
                <div className="ag-timeline-card_info">
          ...
          <div className="js-timeline_item ag-timeline_item">
            ...
            <div className="ag-timeline-card_item">
              <div className="ag-timeline-card_inner">
                <div className="ag-timeline-card_img-box">
                  <img src="https://raw.githubusercontent.com/SochavaAG/example-mycode/master/pens/timeline/images/img-3.png" className="ag-timeline-card_img" width="640" height="360" alt="" />
                </div>
                <div className="ag-timeline-card_info">
          ...
          <div className="js-timeline_item ag-timeline_item">
            ...
            <div className="ag-timeline-card_item">
              <div className="ag-timeline-card_inner">
                <div className="ag-timeline-card_img-box">
                  <img src="https://raw.githubusercontent.com/SochavaAG/example-mycode/master/pens/timeline/images/img-2.png" className="ag-timeline-card_img" width="640" height="360" />
                </div>
                <div className="ag-timeline-card_info">
          ...
          <div className="js-timeline_item ag-timeline_item">
            ...
            <div className="ag-timeline-card_item">
              <div className="ag-timeline-card_inner">
                <div className="ag-timeline-card_img-box">
                  <img src="https://raw.githubusercontent.com/SochavaAG/example-mycode/master/pens/timeline/images/img-1.png" className="ag-timeline-card_img" width="640" height="360" />
                </div>
                <div className="ag-timeline-card_info">
